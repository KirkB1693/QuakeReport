...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String webUrl) {

        Log.i(LOG_TAG, "TEST: extractEarthquakes() has been called");
        ...
        try {
            ...
            JSONObject baseJsonObject = new JSONObject(fetchEarthquakeData(webUrl));
            JSONArray earthquakeArray = baseJsonObject.getJSONArray("features");
            if (earthquakeArray != null && earthquakeArray.length() > 0) {
                for (int i = 0; i < earthquakeArray.length(); i++) {
                    JSONObject quakeObject = earthquakeArray.getJSONObject(i);
